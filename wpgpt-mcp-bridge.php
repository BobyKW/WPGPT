 ...
 * Description: Standalone MCP bridge for WordPress with controlled abilities, secure sandbox tools, and connection flows for ChatGPT and MCP-compatible clients.
 * Version: 1.2.0
 * Author: WPGPT
...
define( 'WPGPT_MCP_BRIDGE_VERSION', '1.2.0' );
