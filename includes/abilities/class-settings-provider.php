...
class Settings_Provider extends Base_Ability_Provider {
    ...
    private function options_apply_schema(): array { return array( 'type'=>'object', 'additionalProperties'=>false, 'properties'=>array( 'action'=>array('type'=>'string','enum'=>array('update_option','delete_transient','delete_expired_transients')), 'dry_run'=>array('type'=>'boolean'), 'targets'=>array('type'=>'array','items'=>array('type'=>'object','additionalProperties'=>false,'properties'=>array('option_name'=>array('type'=>'string'),'key'=>array('type'=>'string')))), 'payload'=>array('type'=>'object','additionalProperties'=>true,'properties'=>array('option_name'=>array('type'=>'string'),'option_value'=>$this->mixed_json_schema(),'keys'=>array('type'=>'array','items'=>array('type'=>'string')))) ), 'required'=>array('action') ); }
    ...
    private function themes_apply_schema(): array { return array( 'type'=>'object', 'additionalProperties'=>false, 'properties'=>array( 'action'=>array('type'=>'string','enum'=>array('activate','update','delete')), 'dry_run'=>array('type'=>'boolean'), 'targets'=>array('type'=>'array','items'=>array('type'=>'object','additionalProperties'=>false,'properties'=>array('stylesheet'=>array('type'=>'string')))), 'filters'=>array('type'=>'object','additionalProperties'=>false,'properties'=>array('stylesheet'=>array('type'=>'string'),'active'=>array('type'=>'boolean'),'update_available'=>array('type'=>'boolean'))) ), 'required'=>array('action') ); }
