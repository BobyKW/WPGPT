    ...
    public static function plugins_api( $result, string $action, $args ) {
        ...
        return (object) array(
            ...
            'sections'       => array(
                ...
                'installation' => wp_kses_post( wpautop( 'Install MCP Adapter first, then install and activate this plugin. Configure your MCP user and credentials from the plugin admin screen.' ) ),
